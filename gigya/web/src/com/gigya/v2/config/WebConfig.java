 ...
 */
package com.gigya.v2.config;


import de.hybris.platform.servicelayer.config.ConfigurationService;
import de.hybris.platform.webservicescommons.swagger.services.ApiVendorExtensionService;
import com.gigya.constants.YcommercewebservicesConstants;
import com.gigya.request.mapping.handler.CommerceHandlerMapping;
...
{
	private static final String PASSWORD_AUTHORIZATION_SCOPE = "gigya.oauth2.password.scope";
	private static final String CLIENT_CREDENTIAL_AUTHORIZATION_SCOPE = "gigya.oauth2.clientCredentials.scope";
	private static final String AUTHORIZATION_URL = "gigya.oauth2.tokenUrl";

	private static final String DESC = "gigya.v2.description";
	private static final String TITLE = "gigya.v2.title";
	private static final String VERSION = "gigya.v2.version";
	private static final String LICENSE = "gigya.v2.license";
	private static final String LICENSE_URL = "gigya.v2.license.url";
